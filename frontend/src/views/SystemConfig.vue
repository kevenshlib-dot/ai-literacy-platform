...
const TYPE_META: Record<string, { label: string; color: string; base_url: string; models: string[]; placeholder: string }> = {
  ...
  vllm:      { label: 'vLLM',        color: 'default', base_url: 'http://localhost:8080/v1',                               models: [],                                                                placeholder: 'meta-llama/Llama-3-8B-Instruct' },
...
const assignments = reactive<Record<string, string | null>>({
  question_generation: null, paper_generation: null, scoring: null, interactive: null,
